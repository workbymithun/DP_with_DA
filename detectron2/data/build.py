...
def print_instances_class_histogram(dataset_dicts, class_names):
    ...
    #print(data) #Use it to debug if required 
...
def _train_loader_from_config_dummy(cfg, mapper=None, *, dataset=None, sampler=None):
    if dataset is None:
        dataset = get_detection_dataset_dicts(
...
@configurable(from_config=_train_loader_from_config_dummy)
def build_detection_train_loader_dummy(
    dataset, *, mapper, sampler=None, total_batch_size, aspect_ratio_grouping=True, num_workers=0
):
    """
    Build a dataloader for object detection with some default features.
